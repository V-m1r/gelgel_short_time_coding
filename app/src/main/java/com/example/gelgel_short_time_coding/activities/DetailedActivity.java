...
public class DetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (viewAllModel != null){
            ...
            price.setText("Price : "+viewAllModel.getPrice()+" Manat/kg");

            totalPrice = viewAllModel.getPrice() * totalQuantity;

            if (viewAllModel.getType().equals("egg")){
                price.setText("Price : \"+viewAllModel.getPrice()+\" Manat/sany");
                totalPrice = viewAllModel.getPrice() * totalQuantity;

            }

            if (viewAllModel.getType().equals("milk")){
                price.setText("Price : \"+viewAllModel.getPrice()+\" Manat/litr");
                totalPrice = viewAllModel.getPrice() * totalQuantity;
